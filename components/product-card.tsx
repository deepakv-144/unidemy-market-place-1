...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden prevent-layout-shift">
      <div className="relative">
        <div className="relative h-64 overflow-hidden cursor-pointer" onClick={handleCardClick}>
          <Image
